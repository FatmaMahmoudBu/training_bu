...
class DepartmentsDataTable extends DataTable
{
    ...
    public function ajax():JsonResponse
    {
        return
             Datatables::of($this->query())
              ->addColumn('id', 'admin.department.buttons.id')
             ->addColumn('edit', 'admin.department.buttons.edit')
             ->addColumn('delete', 'admin.department.buttons.delete')
             ->addColumn('view', 'admin.department.buttons.view')
             /*->addColumn('name', 'admin.department.buttons.langcol')*/
    ...
    {
        return 'Departmentdatatables_' . time();
    }
}
