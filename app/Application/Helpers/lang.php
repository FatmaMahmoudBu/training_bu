...
{
      return url($url);//getCurrentLang().'/'.ltrim($url , '\\'));
}
...
function extractTextFiled ($item = null , $lang = null , $name = null ,  $class = '', $value = null , $transeFile = null)
{
...
function extractTexArea($item = null , $lang = null , $name = null , $rows=8, $class = '', $value = null ,  $transeFile = null)
{
      $title  = $transeFile != null ? adminTrans($transeFile , $name)  : $name;
      $out = '<ul class="nav nav-tabs tab-nav-right" role="tablist">';
      $i = 0;
