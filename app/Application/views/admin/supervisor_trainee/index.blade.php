...
@push('header')
    <button class="btn btn-danger" onclick="deleteThemAll(this)" data-link="{{ url('admin/supervisor_trainee/pluck') }}" ><i class="fa fa-trash"></i></button>
...
@push('search')
    <form method="get" class="form-inline">
        ...
        <a href="{{ url('admin/supervisor_trainee') }}" class="btn btn-danger" ><i class="fa fa-close"></i></a>
    </form>
@endpush

@section('content')
    @include(layoutTable() , ['title' => trans('supervisor_trainee.supervisor_trainee') , 'model' => 'supervisor_trainee' , 'table' => $dataTable->table([] , true) ])
@endsection
