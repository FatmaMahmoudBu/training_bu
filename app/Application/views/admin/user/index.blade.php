...
@section('title')
     {{ trans('home.control') }} {{ trans('user.user') }}
@endsection
...
@push('header')
    <button class="btn btn-danger" onclick="deleteThemAll(this)" data-link="{{ url('admin/user/pluck') }}" ><i class="fa fa-trash"></i> </button>
...
@push('search')
    <form method="get" class="form-inline">
        ...
        <a href="{{ url('admin/user') }}" class="btn btn-danger" ><i class="fa fa-close"></i></a>
    </form>
@endpush
