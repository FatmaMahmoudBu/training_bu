...
@push('header')
    <button class="btn btn-danger" onclick="deleteThemAll(this)" data-link="{{ url('admin/team/pluck') }}" ><i class="fa fa-trash"></i></button>
...
@push('search')
    <form method="get" class="form-inline">
        ...
        <a href="{{ url('admin/team') }}" class="btn btn-danger" ><i class="fa fa-close"></i></a>
    </form>
@endpush

@section('content')
    @include(layoutTable() , ['title' => trans('team.team') , 'model' => 'team' , 'table' => $dataTable->table([] , true) ])
@endsection
