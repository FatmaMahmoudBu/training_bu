...
<div class="pull-{{ getDirection() }} col-lg-9">
        ...
        <form action="{{ concatenateLangToUrl('assignment/item') }}{{ isset($item) ? '/'.$item->id : '' }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
		 ...
		 <div class="form-group {{ $errors->has("report_path") ? "has-error" : "" }}" > 
            ...
            <div class="form-group">
                <button type="submit" name="submit" class="btn btn-default" >
                    ...
                    {{ trans('website.Update') }}  {{ trans('website.assignment') }}
                </button>
            </div>
        </form>
</div>
